...
> **What this is.** The *why* behind `research/funds/core/config/universe.json` (server filter) and
> `research/funds/analyze/screen.js` + `core/config/thresholds.json` (client screen): which funds we hunt,
